...
class TeacherAbsence(Base):
    ...
    teacher_id = Column(Integer, ForeignKey("teachers.id", name="fk_teacher_absences_teacher_id_teachers", ondelete="CASCADE"), nullable=False)
...
class SubstitutionAssignment(Base):
    ...
    substitute_teacher_id = Column(Integer, ForeignKey("teachers.id", name="fk_substitution_assignments_substitute_teacher_id_teachers", ondelete="CASCADE"), nullable=False)
    ...
    substitute_teacher = relationship("Teacher", back_populates="substitutions")
